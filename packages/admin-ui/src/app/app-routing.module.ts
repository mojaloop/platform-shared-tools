...
import {SettlementInitiationReport} from "./report/settlement-initiation-report.component";
...
const routes: Routes = [
	...
	{path: "report/settlement-initiation-report", component: SettlementInitiationReport},

...
export class BulkTransferCreateComponent implements OnInit {
	...
	private _initForm() {
		this.form = new FormGroup({
			...
			"ilpPacket": new FormControl(this.activeTransfer?.inboundProtocolOpaqueState.fspiopOpaqueState.ilpPacket),
			"condition": new FormControl(this.activeTransfer?.inboundProtocolOpaqueState.fspiopOpaqueState.condition),
	...
	async saveTransfer() {
		...
		this.activeTransfer.inboundProtocolOpaqueState.fspiopOpaqueState.ilpPacket = this.form.controls["ilpPacket"].value;
		this.activeTransfer.inboundProtocolOpaqueState.fspiopOpaqueState.condition = this.form.controls["condition"].value;
		...
		for(let i=1 ; i<51 ; i+=1) {
			individualTransfers.push({
				...
				"ilpPacket": this.activeTransfer.inboundProtocolOpaqueState.fspiopOpaqueState.ilpPacket,
				"condition": this.activeTransfer.inboundProtocolOpaqueState.fspiopOpaqueState.condition
			});
		}
	...
	applyQuote(quoteId?: string) {
		...
		this.form.controls["ilpPacket"].setValue(selectedQuote?.inboundProtocolOpaqueState.fspiopOpaqueState.ilpPacket);
		this.form.controls["condition"].setValue(selectedQuote?.inboundProtocolOpaqueState.fspiopOpaqueState.condition);
